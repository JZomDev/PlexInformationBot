...
public class PlexInformationWorker
{
	...
	PlexFriendlyName plexFriendlyName;

	public PlexInformationWorker(PlexFriendlyName plexFriendlyName)
	{
		this.plexFriendlyName = plexFriendlyName;
	}
	...
	private long buildEpisodeString(StringBuilder stringBuilder, PlexEpisode episode, int index)
	{
		...
		String friendlyName = plexFriendlyName.getName(userID);
